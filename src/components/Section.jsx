  ...
  return (
    <div className='px-1 md:px-10'>
      ...
      <div className='relative group mt-5'>
        ...
        >
          {movies.map((movie) => (
            <SwiperSlide key={movie.id} className='!w-36 md:!w-44'>
              <div className='relative group/card'>
                {/* Movie Rating */}
                <div className='flex absolute top-1 right-2 text-red-600 text-xs md:text-sm items-center gap-1 z-10'>
